...
public class MembersData {
    public static String[][] data = new String[][]{
            {"Soyeon","Leader, Main Rapper, Lead Dancer, Vocalist, Center","https://vignette.wikia.nocookie.net/g-idle/images/1/18/Uh-Oh_Concept_Photo_Soyeon.jpg","Soyeon, also known as Jeon So Yeon is a South Korean singer and rapper under Cube Entertainment. She is the leader, main rapper, lead dancer, center and face of the group of South Korean girl group (G)I-DLE.\n" +
                    ...
                    "\n" +
                    "In July 2016, Soyeon appeared as a contestant in the third season of the rap competition show, Unpretty Rapstar. The show finished with Soyeon ranking in 3rd place, gaining three tracks on the show's final compilation album.\n" +
                    "\n" +
                    "On December 29, 2016, Soyeon signed an exclusive contract as an artist under Cube Entertainment. She officially debuted as a solo-singer on November 5, 2017 with the digital singles \"Jelly\" and \"Idle Song\".\n" +
                    "\n" +
                    "On January 11, 2018, it was announced that Soyeon would be re-debuting in Cube Entertainment's new girl group called (G)I-DLE as the groups leader and main rapper.\n" +
                    "\n" +
                    "On August 8, it was announced that Soyeon will participate in a girl-group collaboration project called Station Young for SM Station's X 0 alongside Red Velvet 's Seulgi, Kim Chung-ha and GFriend's SinB.\n","Background Information","Birth Date\n" +
                    "August 26, 1998\n" +
                    "\n" +
                    "Birth Place\n" +
            ...
            {"Shuhua","Vocalist, Visual, Maknae","https://vignette.wikia.nocookie.net/g-idle/images/6/6a/Uh-Oh_Concept_Photo_Shuhua.jpg","Shuhua, also known as Yeh Shu Hua (葉舒華) is a Taiwanese singer under Cube Entertainment. She is the vocalist, visual and maknae of the South Korean girl group (G)I-DLE.\n" +
                    ...
                    "Visual\n" +
                    "Maknae"},
            {"2Mi","2Mi (Mi/yeon and Mi/nnie) is the friendship pairing between Miyeon and Minnie.","https://vignette.wikia.nocookie.net/g-idle/images/a/a7/2Mi.jpg","2Mi (Mi/yeon and Mi/nnie) is the friendship pairing between Miyeon and Minnie.\n" +
                    "\n" +
                    "Trivia\n" +
                    "\n" + "\n" +
                    "Similarities:\n" +
                    "• Both are the oldest in the group.\n" +
                    "• Both are the best vocalist in the group.\n" +
                    "• Both are born in 1997.\n" +
                    "• Both are roomates.\n" + "\n" +
                    "Differences:\n" +
                    "• Miyeon was born in South Korea while Minnie was born in Thailand.\n" +
                    "• Minnie was introduced in CUBE TREE while Miyeon didn't.\n" +
                    "• Miyeon was a former YG Trainee while Minnie didn't.","Relation Information","Shipped\n" +
                    "Miyeon and Minnie\n" +
                    "\n" +
                    "Other Names\n" +
                    "Yeonnie\n" +
                    ...
                    "Mijin\n" +
                    "Yunnie"},
            {"Tom & Jerry","Tom & Jerry is the bickering pairing between Miyeon (Tom) and Shuhua (Jerry).","https://vignette.wikia.nocookie.net/g-idle/images/0/0f/Mihua.jpg","Tom & Jerry is the bickering pairing between Miyeon (Tom) and Shuhua (Jerry).\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities:\n" +
                    ...
                    "• Miyeon was a former YG Trainee while Shuhua didn't.\n" +
                    "• Shuhua was a Rising Star Cosmetics Model while Miyeon wasn't","Relation Information","Shipped\n" +
                    "Miyeon and Shuhua\n" +
                    "\n" +
                    "Other Names\n" +
                    "Shuyeon\n" +
                    ...
                    "Shuqi\n" +
                    "Shuyeon"},
            {"Mijin","Mijin (Mi/yeon and Soo/jin) is the friendship pairing between Miyeon and Soojin.","https://vignette.wikia.nocookie.net/g-idle/images/1/1b/Mijin.jpg","Mijin (Mi/yeon and Soo/jin) is the friendship pairing between Miyeon and Soojin.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities\n" +
                    ...
                    "• Both are supposed to debut to their former agencies. (Miyeon=BlackPink, Soojin=VIVIDIVA)\n" + "\n" +
                    "Differences\n" +
                    "• Miyeon was born in 1997 while Soojin was born in 1998.\n" +
                    "• Miyeon was a former YG Trainee while Soojin was a former DN Entertainment Trainee.\n" +
                    "• Soojin was introduced in CUBE TREE while Miyeon didn't.","Relation Information","Shipped\n" +
                    "Miyeon and Soojin\n" +
                    "\n" +
                    "Other Names\n" +
                    "Sooyeon\n" +
                    ...
                    "Mihua\n" +
                    "2Mi"},
            {"Shuqi","Shuqi (Shu/hua and Yu/qi) is the friendship pairing between Yuqi and Shuhua.","https://vignette.wikia.nocookie.net/g-idle/images/b/b4/Shuqi.jpg","Shuqi (Shu/hua and Yu/qi) is the friendship pairing between Yuqi and Shuhua.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities:\n" +
                    "• Both are foreigners in the group.\n" +
                    "• Both are the maknaes.\n" +
                    "• Both are Rising Star Cosmetics Model\n" + "\n" +
                    "Differences:\n" +
                    "• Yuqi was born in China while Shuhua was born in Taiwan.\n" +
                    "• Yuqi was born 1999 while Shuhua was born in 2000.\n" +
                    "• Yuqi was in CUBE TREE while Shuhua didn't.","Relation Information","Shipped\n" +
                    "Yuqi and Shuhua\n" +
                    "\n" +
                    "Other Names\n" +
                    "Yuhua\n" +
                    ...
                    "Yuqeon\n" +
                    "Shuyeon"},
            {"Shuyeon","Shuyeon (Shu/hua and So/yeon) is the friendship pairing between Soyeon and Shuhua.","https://vignette.wikia.nocookie.net/g-idle/images/0/07/Shuyeon.jpg","Shuyeon (Shu/hua and So/yeon) is the friendship pairing between Soyeon and Shuhua.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities:\n" +
                    "• Both can sing.\n" +
                    "• Both likes chocolate.\n" + "\n" +
                    "Differences:\n" +
                    "• Soyeon was born in South Korea while Shuhua was born in Taiwan.\n" +
                    "• Soyeon was born in 1998 while Shuhua was born in 2000.","Relation Information","Shipped\n" +
                    "Soyeon and Shuhua\n" +
                    "\n" +
                    "Other Names\n" +
                    "Sohua\n" +
                    ...
                    "Shuqi\n" +
                    "Yuqeon"},
            {"Sooqi","Sooqi (Soo/jin and Yu/qi) is the friendship pairing between Soojin and Yuqi.","https://vignette.wikia.nocookie.net/g-idle/images/9/9d/Sooqi.jpg","Sooqi (Soo/jin and Yu/qi) is the friendship pairing between Soojin and Yuqi.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities\n" +
                    "• Both are introduced in CUBE TREE in 2017.\n" +
                    "• Both are the best dancers of (G)I-DLE.\n" +
                    "• Both can sing, rap and dance.\n" + "\n" +
                    "Differences:\n" +
                    "• Soojin was born in 1998 while Yuqi was born in 1999.\n" +
                    "• Soojin was born in South Korea while Yuqi was born in China.\n" +
                    "• Soojin was a former trainee of DN Entertainment while Yuqi didn't.","Relation Information","Shipped\n" +
                    "Soojin and Yuqi\n" +
                    "\n" +
                    "Other Names\n" +
                    "Yujin\n" +
                    ...
                    "Yunnie\n" +
                    "Yuqeon"},
            {"Yunnie","Yunnie (Yu/qi and Mi/nnie) is the friendship pairing between Minnie and Yuqi.","https://vignette.wikia.nocookie.net/g-idle/images/3/39/Yunnie.jpg","Yunnie (Yu/qi and Mi/nnie) is the friendship pairing between Minnie and Yuqi.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities:\n" +
                    "• Both are Rising Star Cosmetics Model.\n" +
                    "• Both are foreigners in the group.\n" +
                    "• Both are introduced in CUBE TREE..\n" + "\n" +
                    "Differences:\n" +
                    "• Minnie was born in Thailand while Yuqi was born in China.\n" +
                    "• Minnie was born in 1997 while Yuqi was born in 1999.\n" +
                    "• Minnie is left-handed while Yuqi is right-handed.","Relation Information","Shipped\n" +
                    "Minnie and Yuqi\n" +
                    "\n" +
                    "Other Names\n" +
                    "Miqi\n" +
                    ...
                    "Sooqi\n" +
                    "Yuqeon"},
            {"Yuqeon","Yuqeon (Yuq/i and Soy/eon) is the friendship pairing between Soyeon and Yuqi.","https://vignette.wikia.nocookie.net/g-idle/images/1/1f/Yuqeon1.jpg","Yuqeon (Yuq/i and Soy/eon) is the friendship pairing between Soyeon and Yuqi.\n" +
                    "\n" +
                    "Trivia\n" + "\n" +
                    "\n" +
                    "Similarities:\n" +
                    "• Both are Lead Dancers in the group.\n" +
                    "• Both can sing, rap and dance.\n" +
                    "• Both are introduced in CUBE TREE.\n" + "\n" +
                    "Differences:\n" +
                    "• Soyeon was born in South Korea while Yuqi was born in China.\n" +
                    "• Soyeon was born in 1998 while Yuqi was born in 1999.","Relation Information","Shipped\n" +
                    "Soyeon and Yuqi\n" +
                    "\n" +
                    "Other Names\n" +
                    "Soqi\n" +
    ...
    public static ArrayList<Members> getListData(){
        ...
        for (String[] aData : data) {
            ...
            dataMembers.setDetail(aData[3]);
            dataMembers.setInformation(aData[4]);
            dataMembers.setContent(aData[5]);
